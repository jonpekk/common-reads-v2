...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create common-reads-v2-20a6
  fly apps create common-reads-v2-20a6-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app common-reads-v2-20a6
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app common-reads-v2-20a6-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'common-reads-v2-20a6-staging' does not match app name in config file 'common-reads-v2-20a6'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name common-reads-v2-20a6-db
  fly postgres attach --app common-reads-v2-20a6 common-reads-v2-20a6-db

  fly postgres create --name common-reads-v2-20a6-staging-db
  fly postgres attach --app common-reads-v2-20a6-staging common-reads-v2-20a6-staging-db
  ```
